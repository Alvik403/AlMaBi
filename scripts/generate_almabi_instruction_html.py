...
<p><strong>На экране</strong> показываются <strong>целые рубли без копеек</strong> (только отображение). При переключении «тысячи» делится уже отображаемая шкала.</p>
</section>
